...
export class SimulaCambioComponent implements OnInit, OnDestroy {
  ...
  calculaBolivares() {
    ...
    this.bolivares = (Number.parseFloat( this.pesos ) * Number.parseFloat( this.tasa )).toString() ;
    
  }

  carculaPesos() {
    this.pesos = ( Number.parseFloat(this.bolivares) / Number.parseFloat(this.tasa)).toString();
  }
